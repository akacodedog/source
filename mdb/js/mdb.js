                                ...
                                if (a.each(g, function(i, n) {
                                    if (!a.isNullOrUndef(i.label)) {
                                        ...
                                        if (m) {
                                            ...
                                            B < e.top && (s = "rgba(0,0,0,0)"), B += a.aliasPixel(r), L = e.getPixelForTick(n) + u.labelOffset, v = P, b = A, k = t.left, C = t.right + I, y = x = S = D = B
                                        }
                                        M.push({
                                            tx1: v,
                                            ty1: y,
        ...
        t.fn.scrollTo = function(e) {
            ...
            this.each(function() {
                ...
                if (r(), i.after(a), n.hover) {
                    ...
                    o || (i[0] !== e.currentTarget || i.hasClass("active") || 0 !== t(e.target).closest(".dropdown-content").length ? i.hasClass("active") && (l(), t(document).unbind(`click.${a.attr("id")} touchstart.${a.attr("id")}`)) : (e.preventDefault(), s("click")), a.hasClass("active") && t(document).bind(`click.${a.attr("id")} touchstart.${a.attr("id")}`, function(e) {
...
dropdownSelectors.on({
    ...
    function(t) {
        ...
        let i = function(t) {
                ...
                if (!e.hasClass("active")) {
                    e.addClass("active"), document.querySelectorAll("ul .btn-floating").forEach(function(t) {
        ...
        t(".fixed-action-btn:not(.smooth-scroll) > .btn-floating").on("click", function(o) {
            if (!t(e).hasClass("smooth-scroll")) return o.preventDefault(),
                function(t) {
                    let e = t;
    ...
    function(t, e, i, n) {
        ...
        function et(t, e) {
            return t === e ? z : c(t) >= c(e) ? t < 0 ? N : H : e < 0 ? B : j
        }
        ...
        function Nt(t) {
            return t == j ? "down" : t == B ? "up" : t == N ? "left" : t == H ? "right" : ""
        }
        ...
        Vt.prototype = {
            ...
            directionTest: function(t) {
                var e = this.options,
                    ...
                    a = t.deltaX,
                    r = t.deltaY;
                return o & e.direction || (e.direction & Y ? (o = 0 === a ? z : a < 0 ? N : H, i = a != this.pX, n = Math.abs(t.deltaX)) : (o = 0 === r ? z : r < 0 ? B : j, i = r != this.pY, n = Math.abs(t.deltaY))), t.direction = o, i && n > e.threshold && o & e.direction
            },
            attrTest: function(t) {
            ...
            i = function() {
                function i(n, o) {
                    _classCallCheck(this, i), this.defaults = {
                        ...
                        edge: "left",
                        closeOnClick: !1
                    }, this.$element = n, this.options = this.assignOptions(o), this.menuOut = !1, this.$body = t("body"), this.$menu = t(`#${this.$element.attr("data-activates")}`), this.$sidenavOverlay = t("#sidenav-overlay"), this.$dragTarget = t('<div class="drag-target"></div>'), this.$body.append(this.$dragTarget), this.init()
                }
                return _createClass(i, [{
                    ...
                    value: function(t) {
                        if ("left" === this.options.edge) {
                            let e = t >= this.options.MENU_WIDTH / 2;
                            this.menuOut = e, this.$menu.css("transform", `translateX(${t-this.options.MENU_WIDTH}px)`)
                        } else {
                            let e = t < window.innerWidth - this.options.MENU_WIDTH / 2;
                            this.menuOut = e;
                            let i = t - this.options.MENU_WIDTH / 2;
                    ...
                    value: function() {
                        ...
                        this.$element.on("click", function(i) {
                            if (i.preventDefault(), !0 === e.menuOut) e.menuOut = !1, e.removeMenu();
                                ...
                                let i = [];
                                i = "left" === e.options.edge ? [0, -1 * e.options.MENU_WIDTH] : [0, e.options.MENU_WIDTH], e.$menu.velocity({
                                    translateX: i
                                }, {
                                    duration: 300,
                                    queue: !1,
                ...
                value: function() {
                    ...
                    this.$nativeSelectChildren.each(function(i, n) {
                        ...
                        if (o.is("option")) e.buildSingleOption(o, e.isMultiple ? "multiple" : "");
                            ...
                            e.$materialOptionsList.append(i), o.children("option").each(function(i, n) {
    ...
    function() {
        ...
        function C(t, e) {
            ...
            if (l.on(u, function(t) {
                ...
                var q = f("circle");
                q.setAttribute("class", "clockpicker-canvas-fg"), q.setAttribute("r", 5), H.appendChild(j), H.appendChild(Y), H.appendChild(q), H.appendChild(B), N.appendChild(H), z.append(N), this.hand = j, this.bg = Y, this.fg = q, this.bearing = B, this.g = H, this.canvas = z
            }
            T(this.options.init)
        }
    ...
    function(t, e) {
        ...
        return function(t, e, i, n) {
            ...
            o.extend(r, n);
            var s, l, c, u, d, h, p, f, m, g, v, y, b, x, w, k, S, C, T, M, I, P, A, _, O, D, E, L, R, F, $, W, V, z, N, H, B, j, Y, q, X, U, Q, Z, K, G, J, tt, et, it, nt, ot, at, rt, st, lt = {
                    x: 0,
                    y: 0
                },
                ct = {
                ...
                Zt = {
                    ...
                    close: function() {
                        s && (s = !1, l = !0, Ct("close"), o.unbind(window, "resize", a), o.unbind(window, "scroll", m.scroll), o.unbind(document, "keydown", a), o.unbind(document, "mousemove", Ft), $.transform && o.unbind(a.scrollWrap, "click", a), j && o.unbind(window, p, a), Ct("unbindEvents"), Ne(a.currItem, null, !0, a.destroy))
                    },
                    destroy: function() {
                    ...
                    updateSize: function(e) {
                        ...
                        if (dt.x = a.scrollWrap.clientWidth, dt.y = a.scrollWrap.clientHeight, Bt(), ft.x = dt.x + Math.round(dt.x * r.spacing), ft.y = dt.y, Ot(ft.x * ht), Ct("beforeResize"), void 0 !== h) {
                ...
                Me = function(t) {
                    if (!("mousedown" === t.type && t.button > 0)) {
                        ...
                        if (!B || "mousedown" !== t.type) {
                            ...
                            var i = Ce(t),
                                n = i.length;
                            Z = null, Ut(), j && 1 !== n || (j = nt = !0, o.bind(window, p, a), N = rt = ot = H = Q = X = Y = q = !1, it = null, Ct("firstTouchStart", i), Et(ct, ut), lt.x = lt.y = 0, Et(te, i[0]), Et(ee, te), ne.x = ft.x * ht, oe = [{
                                x: te.x,
                                y: te.y
                            }], V = W = Tt(), $t(g, !0), pe(), fe()), !K && n > 1 && !et && !Q && (v = g, q = !1, K = Y = !0, lt.y = lt.x = 0, Et(ct, ut), Et(Kt, i[0]), Et(Gt, i[1]), be(Kt, Gt, de), ue.x = Math.abs(de.x) - ut.x, ue.y = Math.abs(de.y) - ut.y, G = he(Kt, Gt))
                        }
                    }
                },
                Ie = function(t) {
                    ...
                    if (Z) {
                        ...
                        if (0 !== t)
                            if (Et(Kt, Z[0]), Jt.x = Kt.x - te.x, Jt.y = Kt.y - te.y, K && t > 1) {
                                ...
                                })(Tt(), Kt.x, Kt.y), X = !0, J = a.currItem.bounds, Te("x", Jt) || (Te("y", Jt), Lt(ut), Pt())
                            }
                    }
                },
                Ae = function(t) {
                    ...
                    var c = -1;
                    if (0 === l && (j = !1, o.unbind(window, p, a), pe(), K ? c = 0 : -1 !== le && (c = Tt() - le)), le = 1 === l ? Tt() : -1, n = -1 !== c && 150 > c ? "zoom" : "swipe", K && 2 > l && (K = !1, 1 === l && (n = "zoomPointerUp"), Ct("zoomGestureEnded")), Z = null, X || q || et || H)
            ...
            var Re, Fe, $e, We, Ve, ze, Ne = function(e, i, n, s) {
                    ...
                    var d = n ? r.hideAnimationDuration : r.showAnimationDuration,
                        h = function() {
                            qt("initialZoom"), n ? (a.template.removeAttribute("style"), a.bg.removeAttribute("style")) : (Mt(1), i && (i.style.display = "block"), o.addClass(t, "pswp--animated-in"), Ct("initialZoom" + (n ? "OutEnd" : "InEnd"))), s && s(), We = !1
                        };
            ...
            xt("Controller", {
                publicMethods: {
                    ...
                    initController: function() {
                        o.extend(r, je, !0), a.items = Fe = i, Ve = a.getItemAt, ze = r.getNumItemsFn, r.loop, ze() < 3 && (r.loop = !1), St("beforeChange", function(t) {
                            var e, i = r.preload,
                                n = null === t || t >= 0,
                                o = Math.min(i[0], ze()),
                                s = Math.min(i[1], ze());
                    ...
                    setContent: function(t, e) {
                        ...
                        if (l) {
                            ...
                            if (!l.src && l.html && (l.html.tagName ? c.appendChild(l.html) : c.innerHTML = l.html), Ue(l), Ye(l, dt), !l.src || l.loadError || l.loaded) l.src && !l.loadError && ((n = o.createEl("pswp__img", "img")).style.opacity = 1, n.src = l.src, Qe(l, n), qe(0, l, c, n));
                                ...
                                l.loading || Xe(l), a.allowProgressiveImg() && (!$e && $.transform ? Be.push({
                                    item: l,
                                    baseDiv: c,
                                    img: l.img,
                                    index: e,
            ...
            xt("Tap", {
                ...
                publicMethods: {
                    ...
                    handleMouseWheel: function(t) {
                        if (g <= a.currItem.fitRatio) return r.modal && (!r.closeOnScroll || Yt || j ? t.preventDefault() : P && Math.abs(t.deltaY) > 2 && (c = !0, a.close())), !0;
        ...
        t(document).ready(function() {
            ...
            return this.$el = t(this), this.$document = t(document), this.eventsHandled = !1, this.defaultOptions = {
                ...
                this.$document.on("click", this.selectors.chips, function(i) {
                    ...
                    if (t(i.target).is("input, textarea")) return;
